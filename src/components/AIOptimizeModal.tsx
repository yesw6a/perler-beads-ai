    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
      <div className="bg-white dark:bg-gray-900 rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] flex flex-col">
        ...
        <div className="flex-1 overflow-auto p-6">
          ...
          <div className="mb-4 p-3 bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 rounded-lg">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                />
                <label htmlFor="debugMode" className="text-sm font-medium text-purple-900 dark:text-purple-100">
                  🐛 调试模式（直接展示图片，不调用 API）
                </label>
              </div>
            </div>
            {debugMode && (
              <div className="mt-3">
                ...
                <input
                  ...
                  placeholder="https://..."
                  disabled={isProcessing || !!previewImage}
                  className="w-full px-3 py-2 border border-purple-300 dark:border-purple-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-xs focus:ring-2 focus:ring-purple-500 focus:border-transparent disabled:opacity-50"
                />
                <p className="mt-1 text-xs text-purple-600 dark:text-purple-400">
                  💡 粘贴图片 URL 直接测试显示效果，节约 token
                </p>
              </div>
            )}
          </div>
          ...
          {/* API Key 配置 */}
          <div className={`mb-6 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg ${debugMode ? 'opacity-50 pointer-events-none' : ''}`}>
